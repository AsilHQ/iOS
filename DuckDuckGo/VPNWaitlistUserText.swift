...
struct VPNWaitlistUserText {
    ...
    static let networkProtectionPrivacyPolicySection4List = "Dedicated servers means they are not shared with anyone else.\n\nWe rent our servers from providers we carefully selected because they meet our privacy requirements.\n\nWe have strict access controls in place so that only limited Kahf Browser team members have access to our servers."

    static let networkProtectionPrivacyPolicySection5Title = "We protect and limit use of your data when you communicate directly with Kahf Browser."
    ...
    static let networkProtectionTermsOfServiceSection4List = "This service is provided as-is and without warranties or guarantees of any kind.\n\nTo the extent possible under applicable law, Kahf Browser will not be liable for any damage or loss arising from your use of the service. In any event, the total aggregate liability of Kahf Browser shall not exceed $25 or the equivalent in your local currency.\n\nWe may in the future transfer responsibility for the service to a subsidiary of Kahf Browser.  If that happens, you agree that references to “Kahf Browser” will refer to our subsidiary, which will then become responsible for providing the service and for any liabilities relating to it."
